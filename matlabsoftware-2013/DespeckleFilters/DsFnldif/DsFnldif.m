function y = DsFnldif( u, lambda, sigma, m, stepsize, nosteps, varargin)
...
%Examble: out= DsFnldif( a, 4, 0.1, 16, 0.2, 50); 
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
figure, subplot(2,1,1),  imshow(u), title('Original Image');
subplot(2,1,2), imshow(y./255), title('Despeckled Image by DsFnldif'); 
